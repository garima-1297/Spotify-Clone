...
songItems.forEach((element,i) => {
    const audioEl= new Audio(songs[i].filePath);
    console.log(parseInt(audioEl.currentTime));
    element.getElementsByTagName('img')[0].src = songs[i].coverPath;
    element.getElementsByClassName('songName')[0].innerText = songs[i].songName;
    //element.getElementsByClassName('timestamp')[0].innerText = parseInt(audioEl.duration);
});
